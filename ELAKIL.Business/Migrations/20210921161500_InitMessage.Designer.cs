...
namespace ELAKIL.Business.Migrations
{
    ...
    [Migration("20210921161500_InitMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELAKIL.Business.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7961bc4a-47eb-4dfd-bb4d-2bcb4b2667a1",
                            Email = "Admin@elakil.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@ELAKIL.COM",
                            NormalizedUserName = "ADMIN@ELAKIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAELc3mlNRZja9hwibhCIuN42K1U5dfXYb5iKAyY8hQMVAFK8nMBUQHAkaOqW7mEA/TA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e06d3451-afde-47a8-ac5c-5c54847aae22",
            ...
            modelBuilder.Entity("ELAKIL.Business.Entities.Message", b =>
                {
                    b.HasOne("ELAKIL.Business.Entities.UserProfile", "FromUserProfile")
                        .WithMany()
                        .HasForeignKey("FromUserProfileId");

                    b.HasOne("ELAKIL.Business.Entities.UserProfile", "ToUserProfile")
                        .WithMany()
